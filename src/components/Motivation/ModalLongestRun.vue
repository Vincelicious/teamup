  ...
  <div class="app flex justify-center content-center bg" v-show="value">
    <div class="modal w-11/12">
      <div class="container flex flex-col">
        <p class="text-center text-2xl pt-2 pb-6 font-bold ">Longest Run</p>
        <lottie
        ...
        />
        <p class="text-center text-2xl py-2 font-bold">20 km</p>
...
import LongestRun from "@/assets/badges/longest-run-badge.json";
