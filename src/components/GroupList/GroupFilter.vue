...
<template>
  ...
  <div class="flex mb-4 mt-8">
    ...
    <div class="flex mb-4 mt-12">
      <map-pin-icon class="card-icon" />
      <p>Distance</p>
    </div>

    <div class="slider">
      <vue-slider v-model="group.groupdistance" :min="1" :max="100" :tooltip-placement="['bottom']" :tooltip="'always'" />
    </div>
  ...
  methods: {
    create: function() {
      GroupService.createGroup({
        ...
        maxDistance: this.group.groupdistance,
