<template>
  ...
  <div class="flex justify-center text-white">
    <!-- Group Card -->
    <div class="flex flex-col bg-gray-500 m-3 w-full h-40 p-5 rounded-lg bg-darkened-color">
      <!-- Title -->
      ...
      <div class="flex">
        <div class="card-training-days mr-2 " v-for="day in group.trainingDays" :key="day" :group="group">
          {{ day }}
        </div>
      </div>
      ...
      <div class="group-info flex h-full items-end">
        <div class="flex mr-5">
          ...
          <p class="min-w-8">{{ group.members.length }} / {{ group.maxMembers }}</p>
        </div>
        <div class="flex mr-5">
...
<script>
import { MapPinIcon, TargetIcon, UsersIcon, ChevronRightIcon } from "vue-feather-icons";
